...
describe('testing Row component', () => {
    it('should render Row', () => {
        ...
        const wrapper = shallow(<Row rowCells={rowCells} pageName="somePageModifier" uniqueRowId="uniqueRowId" uniqueRowId="uniqueRowId"/>)
    ...
    it('should render Row without withAction class', () => {
        ...
        const wrapper = shallow(<Row rowCells={rowCells} withActions={false} pageName="somePageModifier" uniqueRowId="uniqueRowId" />)
    ...
    it('should render Row without pageName specific class', () => {
        ...
        const wrapper = shallow(<Row rowCells={rowCells} pageName="somePageModifier" uniqueRowId="uniqueRowId" />)
    ...
    describe('testing for text type cells', () => {
         ...
         it('should render Row with text cell type', () => {
            ...
            const wrapper = shallow(<Row pageName="somePageModifier" uniqueRowId="uniqueRowId" rowCells={rowCells} />)
